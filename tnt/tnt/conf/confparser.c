...
void confparser_set_defaults_tnt_config(tnt_config *conf) {
	...
	conf->brake_kp0 = APPCONF_TNT_BRAKE_KP0;
	conf->brakekp_rate = APPCONF_TNT_BRAKEKP_RATE;
	conf->brakecurrent1 = APPCONF_TNT_BRAKE_CURRENT1;
	conf->brakecurrent2 = APPCONF_TNT_BRAKE_CURRENT2;
	conf->brakecurrent3 = APPCONF_TNT_BRAKE_CURRENT3;
	conf->brakecurrent4 = APPCONF_TNT_BRAKE_CURRENT4;
	conf->brakecurrent5 = APPCONF_TNT_BRAKE_CURRENT5;
	conf->brakecurrent6 = APPCONF_TNT_BRAKE_CURRENT6;
	conf->brakepitch1 = APPCONF_TNT_BRAKE_PITCH1;
	conf->brakepitch2 = APPCONF_TNT_BRAKE_PITCH2;
	conf->brakepitch3 = APPCONF_TNT_BRAKE_PITCH3;
	conf->brakepitch4 = APPCONF_TNT_BRAKE_PITCH4;
	conf->brakepitch5 = APPCONF_TNT_BRAKE_PITCH5;
	conf->brakepitch6 = APPCONF_TNT_BRAKE_PITCH6;
	...
	conf->haptic_buzz_hv = APPCONF_TNT_HAPTIC_BUZZ_HV;
	conf->haptic_buzz_lv = APPCONF_TNT_HAPTIC_BUZZ_LV;
	conf->haptic_buzz_temp = APPCONF_TNT_HAPTIC_BUZZ_TEMP;
