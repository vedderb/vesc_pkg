    ...
    Connections {
        ...
        onCustomAppDataReceived: {
            ...
            if (msgtype == 1) {
                ...
                var basekp = dv.getFloat32(ind); ind += 4;
                var current = dv.getFloat32(ind); ind += 4;
                var stablkp = dv.getFloat32(ind); ind += 4;
                var stablkprate = dv.getFloat32(ind); ind += 4;
                ...
                var stabl = dv.getFloat32(ind); ind += 4;
                ...
                tune.text =
                    ...
                    "Base Pitch Kp       : " + basekp.toFixed(0) + " \n" +         
                    "Stability Kp        : " + stablkp.toFixed(0) + " \n" + 
                    "Stability Rate Kp   : " + stablkprate.toFixed(2) + " \n" +
                    "Roll                : " + roll.toFixed(2) + "°\n" +
                ...
                setpoints.text =
                    ...
                    "Relative Stability  : " + (stabl * 100).toFixed(0) + "%\n" +
