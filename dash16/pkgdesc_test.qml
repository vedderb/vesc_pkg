...
Item {
    property string pkgName: "Dash16 HWTEST"
    property string pkgDescriptionMd: "README_test.md"
    property string pkgLisp: "hwtest.lisp"
    property string pkgQml: "ui.qml"
    property bool pkgQmlIsFullscreen: false
    property string pkgOutput: "dash16_test.vescpkg"
