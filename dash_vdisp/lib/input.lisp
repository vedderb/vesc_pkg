...
(defun input-thread () {
        ...
        (loopwhile t {
                ...
                ; This display exposes its four buttons through read-button:
                ; button 0 is an analog input and 1-3 come from the I2C GPIO
                ; expander. There is no ADC to drive over I2C, and no reason to
                ; stop reading while USB is connected the way Dash35B does.
