...
Item {
    ...
    readonly property string const_ebike_VERSION: "<unknown>"
    readonly property string const_ebike_RELEASE_DATE: "<unknown>"
                        ...
                        Rectangle {
                            ...
                            CustomGauge {
                                ...
                                Image {
                                    ...
                                    source : "https://raw.githubusercontent.com/vedderb/vesc_pkg/main/ebike/assets/shark_with_laser.png"
                                ...
                                Text {
                                    ...
                                    text:
                                        ...
                                        "Runtime version:<br>" +
                                        "- " + const_ebike_VERSION + "<br>" +
                                        "Runtime build timestamp:<br>" +
                                        "- " + const_ebike_RELEASE_DATE + "<br>" +
