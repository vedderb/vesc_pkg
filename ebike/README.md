...
![E-Bike Pkg Logo](https://raw.githubusercontent.com/vedderb/vesc_pkg/main/ebike/assets/shark_with_laser.png)
...
\* this model can be upgraded with a Bluetooth module to enable Bluetooth connectivity, see [these instructions](https://github.com/vedderb/vesc_pkg/blob/main/ebike/BLUETOOTH_UPGRADE.md)
...
- **Documentation:** See [DEVELOPMENT.md](https://github.com//vedderb/vesc_pkg/blob/main/ebike/DEVELOPMENT.md) for technical details
