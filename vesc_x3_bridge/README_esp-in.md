...
of custom firmware. A companion **VESC X3 Bridge** PCB exists, on which
this package was developed and tested. This script is designed to run on
that PCB's firmware specifically, and won't install on other boards.
