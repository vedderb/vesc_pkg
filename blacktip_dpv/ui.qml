...
Item {
    ...
    property int receivedAdcMultiplierX10: 161  // round-tripped from device; balance-wire ADC multiplier in 0.1x units (default 161 = 16.1x)
    ...
    function write_settings () {
        ...
        da.setUint8(31, receivedAdcMultiplierX10) // Balance-wire ADC multiplier x10 (5.0..25.5x, default 16.1x)
        mCommands.sendCustomAppData(buffer)
    ...
    function reset_defaults_blacktip() {
        ...
        da1.setUint8(31, 161) // Balance-wire ADC multiplier x10 default: 161 = 16.1x (measured on reference Blacktip)
